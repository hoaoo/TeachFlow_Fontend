...
export async function randomizeSeatingPlan(id: string) { return api.post<SeatingPlan>('/seating-plans/' + id + '/randomize', {}); }
export async function resetSeatingPlan(id: string) { return api.post<SeatingPlan>('/seating-plans/' + id + '/reset', {}); }
